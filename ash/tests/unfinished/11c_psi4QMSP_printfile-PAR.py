...
Psi4SPcalculation = Psi4Theory(fragment=HF_frag, charge=0, mult=1, psi4settings=psi4dictvar, psi4method=psi4method, runmode='library', printsetting=True, numcores=4)
