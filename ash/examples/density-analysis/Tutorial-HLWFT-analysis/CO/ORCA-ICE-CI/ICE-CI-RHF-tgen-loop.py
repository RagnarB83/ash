...
nmin=1.999
nmax=0.00
initial_orbitals="MP2" #Using MP2 natural orbitals to do the selection
no_moreadfile_in_CAS=True  #But not using the MP2-orbitals, HF orbitals will be used instead
#Call function
for tgen in [10,1,5e-1,1e-1,5e-2,1e-2,5e-3,1e-3,5e-4,1e-4,5e-5,1e-5,5e-6,1e-6]:
    Auto_ICE_CAS(fragment=frag, basis=basis, nmin=nmin, nmax=nmax, numcores=numcores, CASCI=True, tgen=tgen, memory=10000,
        initial_orbitals=initial_orbitals, no_moreadfile_in_CAS=no_moreadfile_in_CAS)
