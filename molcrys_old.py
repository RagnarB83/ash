...
#Define fragment types: Descriptive name, list of elements, charge, mult
mainfrag = Fragmenttype("Fecomplex","Fe2O4N3C8S2H5", charge=-2,mult=1)
counterfrag1 = Fragmenttype("NE4+counterion","NC8H20", charge=1,mult=1)
print("mainfrag:", mainfrag)
...
#print("settings_molcrys.mainfrag:", settings_molcrys.mainfrag)
...
#print("mainfrag.fraglist:", mainfrag.fraglist)
#print("counterfrag1.fraglist:", counterfrag1.fraglist)
