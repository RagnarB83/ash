    ...
    for fragfile in snapshots:
        ...
        if bulkcorr==True:
            ...
            create_orca_inputVIEcomp_pc(name+identifier, inpname_AB, qmregion_elems, qmregion_coords, orcasimpleinput, orcablockinput,
                                    solvsphere.ChargeA, solvsphere.MultA, solvsphere.ChargeB, solvsphere.MultB, solvsphere, '')
            ...
            create_orca_inputVIEcomp_pc(name+identifier, inpname_AB, qmregion_elems, qmregion_coords, orcasimpleinput, orcablockinput,
                                    solvsphere.ChargeA, solvsphere.MultA, solvsphere.ChargeB, solvsphere.MultB, solvsphere, solvbasis)
