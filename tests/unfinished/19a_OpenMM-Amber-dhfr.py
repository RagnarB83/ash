...
#OpenMM recalculated values (calculated using OpenMM 7.4.1 in June 2021).
#ref_energy_components_openmm_RB={'Bond': 611.05, 'Angle':1611.889656353512146, 'Dihedral':8844.317091243306856, 'Nonbonded':-433189.66784224110128, 'Total':-422120.1217066}

#NOTE: The Bond term we calculate via ASH-OpenMM without Parmed is 611.05, agreeing perfectly with Amber non-PBC values in paper
# The total energy from ASH is in perfect agreement. Is the missing bonded terms present as a nonbonded term instead (subject to PBC) ?
#When using OpenMM-Parmed here: /Users/bjornsson/ownCloud/ASH-tests/testsuite/openmm-initial/dhfr-openmm-amber  we get the 613.34 number though
