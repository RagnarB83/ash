...
"""
    ...
    if args.use_reflections:
        ...
        print("rotation_method:", rotation_method)
        exit()
        ...
        print("Case reorder with no reflections")
        print("reorder_method:", reorder_method)
        q_review = reorder_method(p_atoms, q_atoms, p_coord, q_coord)
          
        #print("q_review is:", q_review)
        q_coord = q_coord[q_review]
        #print("new q_coord is", q_coord)
        q_atoms = q_atoms[q_review]
        #print("new q_atoms is:", q_atoms)
    ...
    #RB modification. ONly print atom reordering, q_review is defined above (use_reflections case)
    reorderlist = [q_review.tolist()][0]
    print(*reorderlist, sep=' ')
    exit()
